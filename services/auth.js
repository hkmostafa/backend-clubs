...
var transport = nodemailer.createTransport({host:"smtp.gmail.com",
port:465,
auth:{user: "este.parauni@gmail.com",
pass:"Para12345"}})
...
module.exports = class AuthService {
  ...
  async Login(email, password) {
    const userRecord = await DB.User.findOne({ where: {email:{[Op.eq]:email}} ,include: [
